...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Andrey Kaipov"
    user-mail-address "9457739+andreykaipov@users.noreply.github.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/andrey/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/andrey/bin" "/profile/bin" "/Users/andrey/.npm-packages/bin" "/Users/andrey/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
